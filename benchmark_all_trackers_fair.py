...
from openptv2.batch.pyptv_batch import build_processing_experiment, validate_experiment_setup
...
for f in range(exp.spar.first, exp.spar.last + 1):
    ...
    pts = exp.tracker._run.fb.buf[3].path_x[:exp.tracker._run.fb.buf[3].num_parts].copy()
    frames.append(pts)
