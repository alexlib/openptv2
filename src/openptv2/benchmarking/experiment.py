...
def write_experiment(
    ...
    for i, cal in enumerate(rig.cals):
        cal.to_file(str(cal_dir / f"cam{i + 1}.tif.ori"),
    ...
    write_dataset(
        rig,
        frame_gt,
        DatasetSpec(dir=out_dir, res_sub="res", img_sub="img",
                    first_frame=first_frame, num_cams=len(rig.cals)),
    )
    ...
    yaml_data = {
        ...
        "detect_plate": {
            "gvth_1": 10, "gvth_2": 10, "gvth_3": 10, "gvth_4": 10,
            "max_npix": 400, "max_npix_x": 50, "max_npix_y": 50,
            "min_npix": 25, "min_npix_x": 5, "min_npix_y": 5,
            "size_cross": 3, "sum_grey": 100, "tol_dis": 500,
        },
        "dumbbell": {
            "dumbbell_eps": 3.0, "dumbbell_gradient_descent": 0.05,
            "dumbbell_niter": 500, "dumbbell_penalty_weight": 1.0,
            "dumbbell_scale": 25.0, "dumbbell_step": 1,
        },
        ...
        "orient": {
            "cc": 0, "interf": 0, "k1": 0, "k2": 0, "k3": 0, "p1": 0, "p2": 0,
            "pnfo": 0, "scale": 0, "shear": 0, "xh": 0, "yh": 0,
        },
        ...
        "shaking": {
            "shaking_first_frame": 10000, "shaking_last_frame": 10004,
            "shaking_max_num_frames": 5, "shaking_max_num_points": 10,
        },
        "sortgrid": {"radius": 20},
        "targ_rec": {
            "cr_sz": 2, "disco": 100, "gvthres": [25, 25], "nnmax": 500,
            "nnmin": 10, "nxmax": 100, "nxmin": 10, "nymax": 100, "nymin": 10,
            "sumg_min": 100,
        },
        "track": {
            "angle": 120.0,
