...
from openptv2.gui.pyptv.ptv_calibration import dumbbell_ba_residuals, dumbbell_ba_jac_sparsity
...
def run_dumbbell_calibration(
    ...
    *,
    ...
    jac_sparsity = dumbbell_ba_jac_sparsity(
        per_frame_metric,
        active,
        float(db_weight),
    )
