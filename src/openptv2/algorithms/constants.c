...
#define __PYX_HAVE__algorithms__constants
#define __PYX_HAVE_API__algorithms__constants
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "algorithms.constants" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "algorithms.constants"
extern int __pyx_module_is_main_algorithms__constants;
int __pyx_module_is_main_algorithms__constants = 0;

/* Implementation of "algorithms.constants" */
...
#define __pyx_n_u_ADD_PART __pyx_string_tab[1]
#define __pyx_n_u_CONVERGENCE __pyx_string_tab[2]
#define __pyx_n_u_COORD_UNUSED __pyx_string_tab[3]
#define __pyx_n_u_CORRES_NONE __pyx_string_tab[4]
#define __pyx_n_u_MAXCAND __pyx_string_tab[5]
#define __pyx_n_u_MAX_CANDS __pyx_string_tab[6]
#define __pyx_n_u_MAX_TARGETS __pyx_string_tab[7]
#define __pyx_n_u_NEXT_NONE __pyx_string_tab[8]
#define __pyx_n_u_NUM_ITER __pyx_string_tab[9]
#define __pyx_n_u_POSI __pyx_string_tab[10]
#define __pyx_n_u_POS_INF __pyx_string_tab[11]
#define __pyx_n_u_PREV_NONE __pyx_string_tab[12]
#define __pyx_n_u_PRIO_DEFAULT __pyx_string_tab[13]
#define __pyx_n_u_PT_UNUSED __pyx_string_tab[14]
#define __pyx_n_u_STR_MAX_LEN __pyx_string_tab[15]
#define __pyx_n_u_TR_BUFSPACE __pyx_string_tab[16]
#define __pyx_n_u_TR_MAX_CAMS __pyx_string_tab[17]
#define __pyx_n_u_TR_UNUSED __pyx_string_tab[18]
...
#define __pyx_float_1e20 __pyx_number_tab[1]
#define __pyx_float_0_00001 __pyx_number_tab[2]
...
#define __pyx_int_80 __pyx_number_tab[8]
#define __pyx_int_200 __pyx_number_tab[9]
#define __pyx_int_255 __pyx_number_tab[10]
#define __pyx_int_neg_999 __pyx_number_tab[11]
#define __pyx_int_20000 __pyx_number_tab[12]
...
__Pyx_RefNannySetupContext("PyInit_constants", 0);
  ...
  if (__pyx_module_is_main_algorithms__constants) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "algorithms.constants")) {
      if (unlikely((PyDict_SetItemString(modules, "algorithms.constants", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * PT_UNUSED = -999
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_POSI, __pyx_mstate_global->__pyx_int_80) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)

  /* "algorithms/constants.py":6
 * # tracking_frame_buf.h
 * POSI = 80
 * STR_MAX_LEN = 255             # <<<<<<<<<<<<<<
 * PT_UNUSED = -999
 * CORRES_NONE = -1
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_STR_MAX_LEN, __pyx_mstate_global->__pyx_int_255) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)

  /* "algorithms/constants.py":7
 * POSI = 80
 * STR_MAX_LEN = 255
 * PT_UNUSED = -999             # <<<<<<<<<<<<<<
 * CORRES_NONE = -1
 * PREV_NONE = -1
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_PT_UNUSED, __pyx_mstate_global->__pyx_int_neg_999) < (0)) __PYX_ERR(0, 7, __pyx_L1_error)

  /* "algorithms/constants.py":8
 * STR_MAX_LEN = 255
 * PT_UNUSED = -999
 * CORRES_NONE = -1             # <<<<<<<<<<<<<<
 * PREV_NONE = -1
 * NEXT_NONE = -2
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_CORRES_NONE, __pyx_mstate_global->__pyx_int_neg_1) < (0)) __PYX_ERR(0, 8, __pyx_L1_error)

  /* "algorithms/constants.py":9
 * PT_UNUSED = -999
 * CORRES_NONE = -1
 * PREV_NONE = -1             # <<<<<<<<<<<<<<
 * NEXT_NONE = -2
 * PRIO_DEFAULT = 2
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_PREV_NONE, __pyx_mstate_global->__pyx_int_neg_1) < (0)) __PYX_ERR(0, 9, __pyx_L1_error)

  /* "algorithms/constants.py":10
 * CORRES_NONE = -1
 * PREV_NONE = -1
 * NEXT_NONE = -2             # <<<<<<<<<<<<<<
 * PRIO_DEFAULT = 2
 * 
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_NEXT_NONE, __pyx_mstate_global->__pyx_int_neg_2) < (0)) __PYX_ERR(0, 10, __pyx_L1_error)

  /* "algorithms/constants.py":11
 * PREV_NONE = -1
 * NEXT_NONE = -2
 * PRIO_DEFAULT = 2             # <<<<<<<<<<<<<<
 * 
 * # track.h
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_PRIO_DEFAULT, __pyx_mstate_global->__pyx_int_2) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)

  /* "algorithms/constants.py":14
 * 
 * # track.h
 * MAX_TARGETS = 20000             # <<<<<<<<<<<<<<
 * MAX_CANDS = 4
 * TR_UNUSED = -1
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_MAX_TARGETS, __pyx_mstate_global->__pyx_int_20000) < (0)) __PYX_ERR(0, 14, __pyx_L1_error)

  /* "algorithms/constants.py":15
 * # track.h
 * MAX_TARGETS = 20000
 * MAX_CANDS = 4             # <<<<<<<<<<<<<<
 * TR_UNUSED = -1
 * TR_BUFSPACE = 4
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_MAX_CANDS, __pyx_mstate_global->__pyx_int_4) < (0)) __PYX_ERR(0, 15, __pyx_L1_error)

  /* "algorithms/constants.py":16
 * MAX_TARGETS = 20000
 * MAX_CANDS = 4
 * TR_UNUSED = -1             # <<<<<<<<<<<<<<
 * TR_BUFSPACE = 4
 * TR_MAX_CAMS = 4
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_TR_UNUSED, __pyx_mstate_global->__pyx_int_neg_1) < (0)) __PYX_ERR(0, 16, __pyx_L1_error)

  /* "algorithms/constants.py":17
 * MAX_CANDS = 4
 * TR_UNUSED = -1
 * TR_BUFSPACE = 4             # <<<<<<<<<<<<<<
 * TR_MAX_CAMS = 4
 * ADD_PART = 3
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_TR_BUFSPACE, __pyx_mstate_global->__pyx_int_4) < (0)) __PYX_ERR(0, 17, __pyx_L1_error)

  /* "algorithms/constants.py":18
 * TR_UNUSED = -1
 * TR_BUFSPACE = 4
 * TR_MAX_CAMS = 4             # <<<<<<<<<<<<<<
 * ADD_PART = 3
 * 
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_TR_MAX_CAMS, __pyx_mstate_global->__pyx_int_4) < (0)) __PYX_ERR(0, 18, __pyx_L1_error)

  /* "algorithms/constants.py":19
 * TR_BUFSPACE = 4
 * TR_MAX_CAMS = 4
 * ADD_PART = 3             # <<<<<<<<<<<<<<
 * 
 * # epi.h
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_ADD_PART, __pyx_mstate_global->__pyx_int_3) < (0)) __PYX_ERR(0, 19, __pyx_L1_error)

  /* "algorithms/constants.py":22
 * 
 * # epi.h
 * MAXCAND = 200             # <<<<<<<<<<<<<<
 * 
 * # orientation.h
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_MAXCAND, __pyx_mstate_global->__pyx_int_200) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)

  /* "algorithms/constants.py":25
 * 
 * # orientation.h
 * COORD_UNUSED = -1e10             # <<<<<<<<<<<<<<
 * 
 * # orientation.c
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_COORD_UNUSED, __pyx_mstate_global->__pyx_float_neg_1e10) < (0)) __PYX_ERR(0, 25, __pyx_L1_error)

  /* "algorithms/constants.py":28
 * 
 * # orientation.c
 * NUM_ITER = 80             # <<<<<<<<<<<<<<
 * POS_INF = 1e20
 * CONVERGENCE = 0.00001
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_NUM_ITER, __pyx_mstate_global->__pyx_int_80) < (0)) __PYX_ERR(0, 28, __pyx_L1_error)

  /* "algorithms/constants.py":29
 * # orientation.c
 * NUM_ITER = 80
 * POS_INF = 1e20             # <<<<<<<<<<<<<<
 * CONVERGENCE = 0.00001
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_POS_INF, __pyx_mstate_global->__pyx_float_1e20) < (0)) __PYX_ERR(0, 29, __pyx_L1_error)

  /* "algorithms/constants.py":30
 * NUM_ITER = 80
 * POS_INF = 1e20
 * CONVERGENCE = 0.00001             # <<<<<<<<<<<<<<
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_CONVERGENCE, __pyx_mstate_global->__pyx_float_0_00001) < (0)) __PYX_ERR(0, 30, __pyx_L1_error)

  /* "algorithms/constants.py":1
 * # algorithms/constants.py             # <<<<<<<<<<<<<<
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init algorithms.constants", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init algorithms.constants");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{8},{11},{12},{11},{7},{9},{11},{9},{8},{4},{7},{9},{12},{9},{11},{11},{11},{9},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (210 bytes) */
const char* const cstring = "BZh91AY&SY\313\347\215\330\000\000\001\317\200@\000\000\000\277\247\337@\277/\276\0000\000\270\204M2\023j\236S\324\323A\2013)\351\241\203M\032i\204\304\311\200\201\246\r\004\3205\002z\217P\r\000\027\0035\211Yk\221\010\213\236\225\2268\232\263\005\205\221\366\224\033K \273\322qF\241\335C\233\240VG8`\314\202\345\013\304\230D\232\204\341\016\302S\233\255\253\225\032p\301\022\n\300`K\212\315-\t=_fm\220;g}#R0\"\246`(\025\220z@\214\nXI\202L\271\\\212\247\250n&&\243\256\264\261\204\335\270E+W\205\324\376\333\"I\356\210\232\315a^@Z\270\0225\350\345\220Z\t\320\273\222)\302\204\206_<n\300";
    PyObject *data = __Pyx_DecompressString(cstring, 210, 2);
...
const char* const cstring = "x\332-L\321\016\203 \014\374\264\205A]L\264\220\002\306\267\206)K\314\324e\023\377\177\2406i\357\332\273\336M(\305F\220\223\032;\240\007\240\004\2515)\366\350-(\251\211\3002j\204V\364R\240\312\300\005m!N\344\027g\021zwx\320\267\\; \243m\235\233k\254\014Awh\206j\315\n*\341\033g\334\225o\035q\tj\0003\273\373\312\032!\341:J\321\026\375t\016\363\264F\236VN\2770\304g\030\336\314K\310{\256\3453\356s,l\r\313\201\337=\314'\337b\032\343+\354sbNq\313\363\017\203JQ\247";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (244 bytes) */
const char* const bytes = "?ADD_PARTCONVERGENCECOORD_UNUSEDCORRES_NONEMAXCANDMAX_CANDSMAX_TARGETSNEXT_NONENUM_ITERPOSIPOS_INFPREV_NONEPRIO_DEFAULTPT_UNUSEDSTR_MAX_LENTR_BUFSPACETR_MAX_CAMSTR_UNUSEDcline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
  ...
  }
  {
    ...
    double const c_constants[] = {-1e10,1e20,0.00001};
    for (int i = 0; i < 3; i++) {
  ...
  }
  {
    ...
    int8_t const cint_constants_1[] = {-1,-2,2,3,4,80};
    int16_t const cint_constants_2[] = {200,255,-999,20000};
    for (int i = 0; i < 10; i++) {
