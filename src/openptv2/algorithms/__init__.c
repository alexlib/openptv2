...
#define __pyx_kp_u_algorithms___init __pyx_string_tab[1]
...
namespace {
  ...
  #endif
  {
      ...
      "algorithms",
      __pyx_k_Pure_Python_PTV_algorithms_using, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_algorithms(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_algorithms", 0);
  ...
  if (__pyx_module_is_main_algorithms____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_algorithms___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{19},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (78 bytes) */
const char* const cstring = "x\332%\214A\022\2000\010\003\177\344\027|\n\023[TF\240cK\377/j\016\233\315%+\364h]\342\264\261\020\211K\020\025\025\347t\212\216\302\033\312Ed\310\235\261V\247\362k\016\373\372\236\320\337\007G\345\035S\363#x$\037\355(%\225";
    PyObject *data = __Pyx_DecompressString(cstring, 78, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (94 bytes) */
const char* const bytes = "?algorithms.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
