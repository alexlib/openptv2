...
class Test_ControlParams(unittest.TestCase):
    ...
    def test_read_control(self):
        ...
        self.assertTrue(
            self.cp_obj.get_img_base_name(0) == "dumbbell/cam1_Scene77_4085"
        )
        self.assertTrue(
            self.cp_obj.get_img_base_name(1) == "dumbbell/cam2_Scene77_4085"
        )
        self.assertTrue(
            self.cp_obj.get_img_base_name(2) == "dumbbell/cam3_Scene77_4085"
        )
        self.assertTrue(
            self.cp_obj.get_img_base_name(3) == "dumbbell/cam4_Scene77_4085"
        )
