...
print("1. MyPTV without Gap Recovery (max_gap=0):")
print(
    f"   Average Links / Step: {avg_links_gap0:.1f} / {385.4} ({avg_links_gap0 / 385.4 * 100:.1f}% retention)"
)
print(
    f"   Tracked points: {pts_gap0} / {total_pts} ({pts_gap0 / total_pts * 100:.1f}%)"
)

print("\n2. MyPTV with Gap Recovery (max_gap=1):")
print(
    f"   Average Links / Step: {avg_links_gap1:.1f} / {385.4} ({avg_links_gap1 / 385.4 * 100:.1f}% retention)"
)
print(
    f"   Tracked points: {pts_gap1} / {total_pts} ({pts_gap1 / total_pts * 100:.1f}%)"
)
