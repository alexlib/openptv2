...
def filter_3_scipy(img, filt, imx, imy, min_brightness=8):
    ...
    # In the original, boundaries were left as 0. Mode "constant"
    # leaves them as filtered.
    # We should leave a 1-pixel border as 0 if we want to match exactly,
    # but the plan was to fix boundaries.
