...
def test_compat_correspondences_parity(cavity_dir):
    ...
    try:
        ...
        from algorithms.compat.calibration import Calibration as CCal
        ...
        print(f"\n  --- COMPAT LAYER ---")
        from algorithms.compat.correspondences import correspondences as comp_corr
        from algorithms.compat.correspondences import MatchedCoords as comp_mc
        from algorithms.compat.segmentation import target_recognition as comp_tr
        from algorithms.compat.tracking_framebuf import TargetArray, read_targets
        ...
        from algorithms.tracking_frame_buf import Frame as RFrame
        from algorithms.epi import Coord2d
