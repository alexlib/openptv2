...
from gui.pyptv.parameter_gui import Main_Params, Calib_Params, Tracking_Params, ParamHandler, CalHandler, TrackHandler
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        pm.parameters = {
            ...
            'detect_plate': {
                ...
                'tol_dis': 5, 'min_npix': 5, 'max_npix': 500,
                'min_npix_x': 1, 'max_npix_x': 100,
                'min_npix_y': 1, 'max_npix_y': 100,
                'sum_grey': 200, 'size_cross': 2
            },
            'examine': {
                'Examine_Flag': False,
                'Combine_Flag': False
            ...
            'orient': {
                'pnfo': 10, 'cc': 1, 'xh': 1, 'yh': 1, 'k1': 1, 'k2': 1, 'k3': 1,
                'p1': 1, 'p2': 1, 'scale': 1, 'shear': 1, 'interf': 1
            },
            'shaking': {
