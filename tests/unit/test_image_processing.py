...
def test_split():
    ...
    img_even = np.array([0, 0, 0, 0, 0, 0, 255, 255, 255, 0], dtype=np.uint8).reshape(
        2, 5
    )

    img_odd = np.array(
        [0, 255, 255, 255, 0, 0, 255, 255, 255, 0], dtype=np.uint8
    ).reshape(2, 5)

    erased_half = np.array(
        [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2], dtype=np.uint8
    ).reshape(3, 5)
