...
from openptv2.tracking_presets import TrackingPreset, PRESET_CHOICES, infer_preset
...
def test_default_tracker_is_hybrid_3d_corr():
    ...
    assert BUILTIN_TRACKING_PLUGINS["hybrid_3d_corr"] == "openptv2.plugins.hybrid_tracker"
