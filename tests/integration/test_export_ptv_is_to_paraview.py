...
import numpy as np
import pytest
from gui.pyptv.flowtracks_utils import export_ptv_is_to_paraview
...
def test_export_ptv_is_to_paraview(monkeypatch, tmp_path):
    ...
    def fake_trajectories_ptvis(pattern, xuap=False):
        return fake_trajs
    monkeypatch.setattr("gui.pyptv.flowtracks_utils.trajectories_ptvis", fake_trajectories_ptvis)
    outdir = tmp_path
